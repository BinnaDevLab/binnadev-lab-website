...
export function LessonContentUI({
  lesson,
  navigation,
  metadata,
}: LessonContentUIProps) {
        ...
        <div className="bg-transparent rounded-lg min-h-[60vh]">
          ...
          {activeTab === "youtube" && (
            <div className="flex flex-col items-center justify-center py-32 bg-carbon/30 border border-white/5 rounded-xl border-dashed">
              ...
              <div className="text-xl text-muted mb-2">
                Video Lesson Placeholder
              </div>
              <p className="text-sm text-muted/50">
                YouTube integration goes here.
              </p>
            </div>
          )}
          ...
          {activeTab === "devto" && (
            <div className="flex flex-col items-center justify-center py-32 bg-carbon/30 border border-white/5 rounded-xl border-dashed">
              ...
              <div className="text-xl text-muted mb-2">
                DEV.to Essay Placeholder
              </div>
              <p className="text-sm text-muted/50">
                Expanded technical article goes here.
              </p>
            </div>
          )}
          ...
          {activeTab === "resources" && (
            <div className="flex flex-col items-center justify-center py-32 bg-carbon/30 border border-white/5 rounded-xl border-dashed">
              ...
              <p className="text-sm text-muted/50">
                Downloadable files and external links go here.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="mt-24 pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-6">
          {navigation.prev ? (
            ...
            >
              ...
              <span className="text-lg font-medium text-white group-hover:text-gold transition-colors">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="pt-6 border-t border-white/10">
              <a
                ...
                className="flex items-center justify-between p-3 bg-obsidian border border-white/10 rounded-lg hover:border-white/30 transition-colors group"
              >
                <span className="text-sm font-mono text-white group-hover:text-gold transition-colors">
                  Source Code
                </span>
