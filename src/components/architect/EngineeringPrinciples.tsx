      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        >
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="architect-white-grid" width="80" height="80" patternUnits="userSpaceOnUse">
                <path d="M 80 0 L 0 0 0 80" fill="none" stroke="rgba(168,85,247,0.25)" strokeWidth="1.5" />
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#architect-white-grid)" />
          </svg>
        </motion.div>
                ...
                <ul className="space-y-4 mt-auto w-full">
                  {principle.actionPoints.map((point, i) => (
                    <li key={i} className="flex items-start gap-3">
                      ...
                      <span className="text-sm md:text-base text-obsidian/70 leading-snug">{point}</span>
                    </li>
                  ))}
                </ul>
              </div>
