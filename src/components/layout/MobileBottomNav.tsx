...
const bottomNavLinks = [
  ...
  { label: "Architect", href: "/architect", icon: <Compass className="w-5 h-5" /> },
  { label: "Cohorts", href: "/cohorts", icon: <GraduationCap className="w-5 h-5" /> },
  { label: "Methodology", href: "/philosophy", icon: <BookOpen className="w-5 h-5" /> },
  { label: "Collaborate", href: "/collaborate", icon: <Network className="w-5 h-5" /> },
];
