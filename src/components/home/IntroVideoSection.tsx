    ...
    >
      <Container className="relative z-10 max-w-[1600px] px-0 md:px-6 lg:px-12">
        ...
        >
          ...
          {/* AI Generation Watermark */}
          <div className="absolute top-4 right-4 md:top-6 md:right-6 pointer-events-none z-20 flex items-center gap-2 bg-obsidian/40 backdrop-blur-md px-3 py-1.5 rounded-md border border-white/10 opacity-70 group-hover:opacity-100 transition-opacity">
            <span className="w-1.5 h-1.5 rounded-full bg-gold/80" />
            <Mono className="text-[9px] md:text-[10px] text-white/80 uppercase tracking-widest">
              Generated by Google Flow AI
            </Mono>
          </div>
