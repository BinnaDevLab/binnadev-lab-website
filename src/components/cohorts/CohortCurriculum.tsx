...
export function CohortCurriculum({ curriculum }: CohortCurriculumProps) {
  return (
    <section className="mb-40 relative">
      <Container>
        <div className="mb-16">
          <Mono className="text-gold mb-4 block tracking-[0.2em] uppercase text-xs">The Objective</Mono>
          <H2 className="text-3xl md:text-5xl tracking-tight">What you will actually learn.</H2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {curriculum.map((item, idx) => (
            ...
            >
              ...
              <H3 className="text-2xl mb-4 text-white group-hover:text-gold transition-colors">{item.title}</H3>
