...
export const metadata: Metadata = {
  ...
  description: "Architectural case studies, smart contract experiments, and protocol analysis from BinnaDev Lab.",
};
    ...
    <div className="bg-obsidian min-h-screen relative overflow-hidden">
      ...
      <div className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
        ...
        <Container className="relative z-10 pb-16 pt-40">
          <Mono className="text-gold mb-4 block tracking-widest uppercase">Research</Mono>
          <H1 className="mb-6 max-w-3xl">
            Open work. Shared knowledge.
          </H1>
          <Body className="text-lg text-muted max-w-2xl">
            The Lab builds, audits, and open-sources tools that push the
            boundaries of Ethereum security. Everything we learn, we try to
            share. Publicly.
          </Body>
        </Container>
      </div>
        ...
        <section className="mb-32">
          <div className="border border-white/5 bg-carbon p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            <div className="max-w-xl">
              <Mono className="text-gold mb-3 block tracking-widest uppercase text-xs">On YouTube</Mono>
              ...
              <p className="text-muted text-sm leading-relaxed">
                ...
                projects are published as free videos. Subscribe so you don&apos;t
